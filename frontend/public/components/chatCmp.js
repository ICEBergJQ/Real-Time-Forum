export default function chatComponent() {
    ...
    .hidden { display: none; }
    .chat-header { display: flex; justify-content: space-between; padding: 10px; background:rgb(255, 0, 0); color: white; border-top-left-radius: 8px; border-top-right-radius: 8px; }
    ...
    .chat-input button { margin-left: 5px; padding: 5px 10px; background:rgb(255, 0, 0); color: white; border: none; border-radius: 4px; cursor: pointer; }
    .message { background:rgb(255, 0, 0); padding: 5px; margin: 5px 0; border-radius: 4px; }
    </style>
    `;
}